...
struct EventCallbackStruct {
    ...
    std::function<void(int32_t id, uint8_t* frame, int32_t width, int32_t height)> onVideoFrame = nullptr;
...
DLLEXPORT void SetPlayerCallback(int32_t id, EventCallbackStruct& callbackObj);

DLLEXPORT void PlayerCreate(int32_t id, int32_t video_width,
                            int32_t video_height,
                            int32_t command_line_argument_count,
                            const char** command_line_arguments, EventCallbackStruct& callbackObj);
...
DLLEXPORT const char** MediaParse(const char* type,
...
DLLEXPORT DartDeviceList* DevicesAll();

DLLEXPORT struct DartEqualizer* EqualizerCreateEmpty();

DLLEXPORT struct DartEqualizer* EqualizerCreateMode(int32_t mode);
